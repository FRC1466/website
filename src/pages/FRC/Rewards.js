...
function Rewards_FRC(){
    return(
        <div className="FRC">
            <strong className='article-title'>Awards Given to Our FRC Team</strong>
            <ul className='awards-list'>
                <li>
                    Chairman's Award, 2020 (Smoky Mountain Regional)<br/>
